...
import com.example.adity.scholarquiz.ViewHolder.ScoreDetailViewHolder;
...
viewHolder.text_name.setText(model.getCategoryName());
                viewHolder.text_score.setText(model.getScore());
            }
        };
